...
public class GUI extends JFrame implements ActionListener, KeyListener, ChangeListener {
	...
	Baby extraBaby1 = new Baby(baby1Image);
	Baby extraBaby2 = new Baby(baby2Image);
	Baby extraBaby3 = new Baby(baby1Image);
	Baby extraBaby4 = new Baby(baby2Image);
    /*\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\
     * \\\\\\\    IMAGES AND BABY INSTANCES USED FOR DIFFERENT MODES
     *\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\
     * */
    ...
    private void createGameArea()
    {
        ...
        gameHostingPanel.setPreferredSize(new Dimension(645,480));
    ...
    public void actionPerformed(ActionEvent event) 
    {
    	...
    	if(event.getSource().equals(button2Players))
    	{
    		if(optionTextField.getText().equals("Default"))
    		{
        		...
        		myWorld.addActor(extraBaby2, 80, 100);
        		/*changing the ZOrder of this component to 0 will paint it on the front 
        		 * of other components*/
    		...
    		}else if(optionTextField.getText().equals("4Players"))
    		{
    			...
    			myWorld.removeActor(extraBaby3);
    	...
    	if(event.getSource().equals(button4Players))
    	{
    		...
    		if(optionTextField.getText().equals("Default"))
    		{
        		...
        		myWorld.addActor(extraBaby3, 440, 250);
    	...
    	{
    		JOptionPane.showMessageDialog(this, "Developed by Antonios Triantafyllidis for the Northampton University, \n "
    											+ "as a Project for Problem Solving and Programming (CSY1020) module. ", "About", 
    	...
    	if(event.getSource().equals(hTopicItem))
    	{
    		JOptionPane.showMessageDialog(this, "Movement: \n"
    				...
    				+ "Options: \n"
    				+ "2 Players: Each team has two players \n\n"
    				+ "4 Players: Each team has three players \n\n"
    				+ "Multi: If enabled, will give the player control of one of the main \n"
    				+ "babies (those closer to the middle). The baby can move only up and down \n"
    				+ "using the UP and DOWN arrow keys. Additionally, the player can move the ball\n"
    				+ "with the buttons in the option panel."
    				+ "If disabled, the baby returns to its initial state (automatic movement). \n\n"
    				+ "Game Control: \n"
